...
class LinkComponent extends HTMLElement {
  ...
  get isbutton() {
    return this.getAttribute('isbutton');
  }
  set isbutton(value) { 
    if (value) {
      this.setAttribute('isbutton', value); 
    } else {
      this.removeAttribute('isbutton');
    }
  }
  get isexternal() {
    return this.getAttribute('isexternal');
  }
  set isexternal(value) { 
    if (value) {
      this.setAttribute('isexternal', value); 
    } else {
      this.removeAttribute('isexternal');
    }
  }
  ...
  async connectedCallback() {
    ...
    if (isButton) { 
      ...
      link.setAttribute('class', `link text-link ${colorScheme}`);
    }
