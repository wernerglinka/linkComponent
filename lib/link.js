...
class LinkComponent extends HTMLElement {
  ...
  constructor() {
    ...
    this.updateLink = link => {
      ...
      if (this.props.isbutton) { 
        ...
        link.setAttribute('class', `link text-link`);
    ...
    mutations.forEach((mutation) => {
      ...
      if (mutation.type === 'attributes') {
        if (mutation.attributeName === 'isbutton') {
          this.props.isbutton = mutation.target.getAttribute('isbutton');
        } 

        if (mutation.attributeName === 'isexternal') {
          this.props.isexternal = mutation.target.getAttribute('isexternal');  
        }
      }
      this.updateLink(this.link);
    });
  ...
  async connectedCallback() {
    ...
    this.props.isbutton = this.getAttribute('isbutton');
    this.props.isexternal = this.getAttribute('isexternal');
